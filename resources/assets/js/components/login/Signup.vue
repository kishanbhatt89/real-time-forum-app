<template>
    ...
    <v-container>
        ...
        <v-form @submit.prevent="signup">
            ...
            <v-text-field type="name" v-model="form.name" label="Name" required></v-text-field>
            ...
            <v-text-field type="password" v-model="form.password_confirmation" label="Confirm Password" required></v-text-field>
